...
namespace ImGui
{
    ...
    IMGUI_API void          RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0,0), const ImRect* clip_rect = NULL, bool tab = false, bool selected = false, bool scaled = false);
	...
	IMGUI_API bool			TextExecute(const char * label, const ImVec2 & size_arg, ImGuiButtonFlags flags = 0, bool tab = false, bool selected = false);
    ...
    IMGUI_API bool          SliderBehavior(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags = 0, ImVec4 color = ImVec4(0, 0, 0, 0), const char* format = "");
	...
	IMGUI_API bool          SliderBehaviorC(const ImRect& frame_bb, ImGuiID id, float* v, float v_min, float v_max, float power, int decimal_precision, ImGuiSliderFlags flags = 0);
